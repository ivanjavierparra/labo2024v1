...
exp_lib <- paste0( envg$EXPENV$repo_dir,"/exp/04EC/z590_exp_lib_01.r")
source( exp_lib )
...
DT_incorporar_dataset_default <- function( pmyexp, parch, pserver="local")
{
  ...
  param_local$meta$script <- "/exp/04EC/z511_DT_incorporar_dataset.r"
...
CA_catastrophe_default <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/exp/04EC/z521_CA_reparar_dataset.r"
...
DR_drifting_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/exp/04EC/z531_DR_corregir_drifting.r"
...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/exp/04EC/z541_FE_historia.r"
...
TS_strategy_guantesblancos_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/exp/04EC/z551_TS_training_strategy.r"
...
HT_tuning_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/exp/04EC/z561_HT_lightgbm.r"
...
ZZ_final_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/exp/04EC/z571_ZZ_final.r"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001-e004", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001-e004", "DT0001-e004" )

  DR_drifting_guantesblancos( "DR0001-e004", "CA0001-e004" )
  FE_historia_guantesblancos( "FE0001-e004", "DR0001-e004" )

  TS_strategy_guantesblancos_202109( "TS0001-e004", "FE0001-e004" )

  HT_tuning_guantesblancos( "HT0001-e004", "TS0001-e004" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001-e004", c("HT0001-e004","TS0001-e004") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002-e004", "FE0001-e004" )

  HT_tuning_guantesblancos( "HT0002-e004", "TS0002-e004" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002-e004", c("HT0002-e004", "TS0002-e004") )
...
corrida_guantesblancos_202109( "gb01-e004" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

# corrida_guantesblancos_202107( "gb02-e004" )
