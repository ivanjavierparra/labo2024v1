...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001-e01", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001-e01", "DT0001-e01" )

  DR_drifting_guantesblancos( "DR0001-e01", "CA0001-e01" )
  FE_historia_guantesblancos( "FE0001-e01", "DR0001-e01" )

  TS_strategy_guantesblancos_202109( "TS0001-e01", "FE0001-e01" )

  HT_tuning_guantesblancos( "HT0001-e01", "TS0001-e01" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001-e01", c("HT0001-e01","TS0001-e01") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002-e01", "FE0001-e01" )

  HT_tuning_guantesblancos( "HT0002-e01", "TS0002-e01" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002-e01", c("HT0002-e01", "TS0002-e01") )
...
corrida_guantesblancos_202109( "gb01-e01" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02-e01" )
